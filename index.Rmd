...
``````{r, echo = FALSE, code = readLines("chart1_Caleb_Lykken.R")}
library(tidyverse)
library(plotly)
...
Describe why you chose this chart and what information it reveals - TYLER
...
>>>>>>> dec9136715c20997de9a526bc2b9add7d26cec83
